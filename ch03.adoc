...
The standard name table is located at link:$$https://cfconventions.org/Data/cf-standard-names/current/src/cf-standard-name-table.xml$$[test] NO COMMA
...
A formatted text version of the table is provided at link:$$https://cfconventions.org/Data/cf-standard-names/current/build/cf-standard-name-table.html$$[test2] NO COMMA and this table may be consulted in order to find the standard name that should be assigned to a variable.
