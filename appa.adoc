...
* **U** for uncertainty variables (see <<uncertainty>>),
...
| Records the instructions that define how to create the aggregated data of an aggregation variable.
...
| Gives a positive numerical “coverage factor” for the coverage interval.

| **`coverage_interval`**
| S
| U
| <<uncertainty-variable-attributes>>
| Specifies how the uncertainty variable array defines the coverage interval.

| **`coverage_probability`**
| N
| U
| <<uncertainty-variable-attributes>>
| Contains the probability that the coverage interval contains the true data variable value.
...
| U
| <<error-correlation>>
| Used to describe the correlations of errors across the domain.
...
| Used to describe the mathematical form of the probability distribution that characterizes the dispersion of the values that could reasonably be attributed to the data variable.
...
| Identifies a dimension to which the values in this variable are indices, used for selection of climatological time coordinates for norm metadata variables.
...
| U
| <<uncertainty-variable-attributes>>
| Describes the component of the uncertainty represented by the uncertainty variable.

| **`uncertainty_evaluation`**
| S
| U
| <<uncertainty-variable-attributes>>
| Describes the method used to evaluate the uncertainty.

| **`uncertainty_representation`**
| S
| U
| <<uncertainty-variable-attributes>>
| Specifies whether the uncertainty variable array represents absolute or relative differences to the data variable values.

| **`uncertainty_variables`**
| S
| D
| <<uncertainty>>
| Identifies variables that provide metadata about the uncertainty in the measurement of a quantity described by the data variable.
