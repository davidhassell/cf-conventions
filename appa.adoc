...
|**`external_variable_identifiers`**
| S
| G
| <<external-variables>>
| Records identifiers for external variables.

|**`external_variables`**
| S
| G
| <<external-variables>>
| Identifies variables which are named by selected attributes in the file but which are not present in the file.
...
| -
| <<external-variables>>
| Records an identifier for an external variable in an external file.
