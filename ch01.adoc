...
aggregation variable:: A variable whose data is defined by as a virtual aggregation of fragments, rather than containing its own data. Any kind of variable may be an aggregation variable, apart from a coordinate variable.
