...
=== Version 1.15-draft (most recent first)

* {issues}???[Issue #660]: Uncertainty metadata: New chapter 10 and appendix N

=== Version 1.14-draft (most recent first)

* {issues}647[Issue #647]: Add Appendix D entry for atmospheric_hybrid_sigma_ln_pressure_coordinate
* {issues}624[Issue #624], {issues}625[Issue #625]: Consistent representation of datetimes and use of calendar attribute
