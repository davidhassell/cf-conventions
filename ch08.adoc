...
[[compression-by-coordinate-sampling, Section 8.3, "Compression by Coordinate Sampling"]]
=== Compression by Coordinate Sampling
...
enough to not be of concern to user of the uncompressed data.
